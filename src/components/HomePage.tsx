...
export const HomePage: React.FC<HomePageProps> = ({ onContactClick, onCalculatorClick }) => {
  ...
  useEffect(() => {
    ...
    if (
      ...
      currentLevel >= 50 && 
      currentLevel < 100 && 
      (!desiredLevel || desiredLevel === '' || (typeof desiredLevel === 'number' && desiredLevel <= 100))
    ) {
    ...
    <div className="min-h-screen pt-20 md:pt-24 pb-12">
      ...
      <section className="px-4 md:px-6 py-12 md:py-20">
        <div className="max-w-6xl mx-auto text-center animate-fadeIn">
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold bg-gradient-to-r from-cyan-400 via-blue-400 to-purple-400 bg-clip-text text-transparent mb-4 md:mb-6 animate-fadeIn">
            <span className="hero-text block animate-heroTextScale">Free Fire Level Up Service</span>
          </h1>
          <p className="text-lg md:text-xl lg:text-2xl text-gray-300 mb-6 md:mb-8 max-w-3xl mx-auto animate-slideUp px-4">
            Professional Free Fire level up service. Get to your desired level quickly, safely, and affordably.
          </p>
          
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-slideUp px-4" style={{ animationDelay: '0.4s' }}>
            <button
              onClick={onCalculatorClick}
              className="w-full sm:w-auto px-6 md:px-8 py-3 md:py-4 bg-gradient-to-r from-cyan-500/20 to-blue-600/20 backdrop-blur-md border border-cyan-400/30 text-white font-bold rounded-xl hover:from-cyan-500/40 hover:to-blue-600/40 hover:border-cyan-400/60 hover:shadow-2xl hover:shadow-cyan-500/40 transform hover:scale-110 hover:-translate-y-1 transition-all duration-500 shadow-lg shadow-cyan-500/25 flex items-center justify-center space-x-2 animate-buttonPulse"
            >
            ...
            <button
              ...
              className="w-full sm:w-auto px-6 md:px-8 py-3 md:py-4 bg-gradient-to-r from-purple-500/20 to-pink-600/20 backdrop-blur-md border border-purple-400/30 text-white font-bold rounded-xl hover:from-purple-500/40 hover:to-pink-600/40 hover:border-purple-400/60 hover:shadow-2xl hover:shadow-purple-500/40 transform hover:scale-110 hover:-translate-y-1 transition-all duration-500 shadow-lg shadow-purple-500/25 flex items-center justify-center space-x-2 animate-buttonPulse"
      ...
      <section id="calculator-section" className="px-4 md:px-6 py-8 md:py-16">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Results */}
          {isCalculating && (
            <div className="bg-gradient-to-br from-cyan-500/10 to-blue-600/10 backdrop-blur-xl rounded-2xl md:rounded-3xl p-6 md:p-8 border border-cyan-400/20 shadow-2xl shadow-cyan-500/20 animate-cardGlow">
              <div className="flex items-center justify-center space-x-4">
                <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-cyan-400"></div>
                <span className="text-cyan-400 font-medium">Calculating your quote...</span>
              </div>
            </div>
          )}
        ...
        <div className="max-w-6xl mx-auto animate-fadeIn">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
            <div className="bg-gradient-to-br from-cyan-500/15 to-blue-600/15 backdrop-blur-xl rounded-xl md:rounded-2xl p-6 md:p-8 border border-cyan-400/30 shadow-xl shadow-cyan-500/20 text-center transform hover:scale-105 transition-all duration-300 group">
              <div className="w-12 md:w-16 h-12 md:h-16 bg-gradient-to-br from-cyan-500/20 to-blue-600/20 backdrop-blur-md border border-cyan-400/40 rounded-xl md:rounded-2xl flex items-center justify-center mx-auto mb-4 md:mb-6 group-hover:animate-glow group-hover:scale-110 transition-transform duration-300">
            ...
            <div className="bg-gradient-to-br from-green-500/15 to-emerald-600/15 backdrop-blur-xl rounded-xl md:rounded-2xl p-6 md:p-8 border border-green-400/30 shadow-xl shadow-green-500/20 text-center transform hover:scale-105 transition-all duration-300 group">
              <div className="w-12 md:w-16 h-12 md:h-16 bg-gradient-to-br from-green-500/20 to-emerald-600/20 backdrop-blur-md border border-green-400/40 rounded-xl md:rounded-2xl flex items-center justify-center mx-auto mb-4 md:mb-6 group-hover:animate-glow group-hover:scale-110 transition-transform duration-300">
            ...
            <div className="bg-gradient-to-br from-purple-500/15 to-pink-600/15 backdrop-blur-xl rounded-xl md:rounded-2xl p-6 md:p-8 border border-purple-400/30 shadow-xl shadow-purple-500/20 text-center transform hover:scale-105 transition-all duration-300 group">
              <div className="w-12 md:w-16 h-12 md:h-16 bg-gradient-to-br from-purple-500/20 to-pink-600/20 backdrop-blur-md border border-purple-400/40 rounded-xl md:rounded-2xl flex items-center justify-center mx-auto mb-4 md:mb-6 group-hover:animate-glow group-hover:scale-110 transition-transform duration-300">
            ...
            <div className="bg-gradient-to-br from-yellow-500/15 to-orange-600/15 backdrop-blur-xl rounded-xl md:rounded-2xl p-6 md:p-8 border border-yellow-400/30 shadow-xl shadow-yellow-500/20 text-center transform hover:scale-105 transition-all duration-300 group">
              <div className="w-12 md:w-16 h-12 md:h-16 bg-gradient-to-br from-yellow-500/20 to-orange-600/20 backdrop-blur-md border border-yellow-400/40 rounded-xl md:rounded-2xl flex items-center justify-center mx-auto mb-4 md:mb-6 group-hover:animate-glow group-hover:scale-110 transition-transform duration-300">
