...
export const ContactPage: React.FC = () => {
  const { getLinkByPlatform, loading } = useSocialLinks();
      ...
      <div className="min-h-screen pt-24 md:pt-32 pb-12 px-4 md:px-6">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center justify-center py-12">
            ...
            <span className="text-cyan-400 font-medium ml-4">Loading contact information...</span>
          </div>
        </div>
      </div>
    );
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
          ...
          >
            <div className="flex items-center space-x-4 md:space-x-6">
              <div className="w-16 md:w-20 h-16 md:h-20 bg-gradient-to-br from-indigo-500/20 to-purple-600/20 backdrop-blur-md border border-indigo-400/40 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
          ...
          >
            <div className="flex items-center space-x-4 md:space-x-6">
              <div className="w-16 md:w-20 h-16 md:h-20 bg-gradient-to-br from-green-500/20 to-emerald-600/20 backdrop-blur-md border border-green-400/40 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group bg-gradient-to-br from-blue-500/15 to-indigo-600/15 backdrop-blur-xl rounded-2xl md:rounded-3xl p-6 md:p-8 border border-blue-400/30 shadow-xl shadow-blue-500/20 transform hover:scale-105 hover:shadow-2xl hover:shadow-blue-500/30 hover:-translate-y-2 transition-all duration-500 block"
          >
            <div className="flex items-center space-x-4 md:space-x-6">
              <div className="w-16 md:w-20 h-16 md:h-20 bg-gradient-to-br from-blue-500/20 to-indigo-600/20 backdrop-blur-md border border-blue-400/40 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group bg-gradient-to-br from-pink-500/15 to-rose-600/15 backdrop-blur-xl rounded-2xl md:rounded-3xl p-6 md:p-8 border border-pink-400/30 shadow-xl shadow-pink-500/20 transform hover:scale-105 hover:shadow-2xl hover:shadow-pink-500/30 hover:-translate-y-2 transition-all duration-500 block"
          >
            <div className="flex items-center space-x-4 md:space-x-6">
              <div className="w-16 md:w-20 h-16 md:h-20 bg-gradient-to-br from-pink-500/20 to-rose-600/20 backdrop-blur-md border border-pink-400/40 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
